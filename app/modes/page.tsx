  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-950 to-black text-white flex items-center justify-center p-4 overflow-hidden">
      <div className="max-w-6xl w-full space-y-12 relative">
        ...
        <div className="px-4">
          <Card className="group bg-black/40 border-purple-500/20 backdrop-blur-sm hover:bg-black/60 transition-all duration-300 hover:border-purple-500/40">
            <CardContent className="py-4 flex justify-between items-center">
              ...
              <Button
                ...
                className="bg-purple-600/80 hover:bg-purple-500 text-white shadow-lg shadow-purple-500/20 transition-all duration-300 hover:shadow-purple-500/40 px-8"
                size="lg"
              >
                Surprise Me! 🤯
              </Button>
